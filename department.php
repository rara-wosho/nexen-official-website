    ...
    try {
        ...
        if ($department) {
            $stmt = $connection->prepare("
                ...
                JOIN department_members dm ON tm.id = dm.member_id
...
<head>
    ...
    <title><?= htmlspecialchars($department['department_name']) ?> | NEXEN Innovation Technologies Inc.</title>
...
<body>
    ...
    <main class="position-relative" style="padding-block: 5rem;">
    <!-- MEET THE TEAM -->
        <section id="meet-the-team" class="mx-auto max-w-wrapper py-5">
            <div class="mb-4">
                ...
                <h2 class="urbanist text-secondary-foreground">Meet the <?= htmlspecialchars($department['department_name']) ?> Team</h2>
                <p class="text-muted-foreground fs-7"><?= htmlspecialchars($department['department_description'] ?: 'Get to know the amazing people behind this department.') ?></p>
            </div>
            ...
            <div class="row row-cols-1 px-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                ...
                <?php else: ?>
                    <div class="col-12 text-center">
                        <p class="text-muted-foreground text-start">No team members found in this department.</p>
                    </div>
                <?php endif; ?>
            </div>
        </section>
